...
# ra = [x for x in range(20, 241) if x % 20 == 0 or x % 21 == 0]
# print(ra)
...
"""
# sp = [randint(1,30) for x in range(1,30)]
# print (sp)
# op = [x for x in sp if sp.count(x) == 1]
# print(op)
...
"""
# ru = [x for x in range(100, 1001) if x % 2 == 0]
# print(ru)
# def reduce_fun(el, ellast):
#     return el * ellast
from functools import reduce
# print(reduce(reduce_fun, ru))
